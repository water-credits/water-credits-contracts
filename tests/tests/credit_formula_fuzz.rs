...
fn test_fuzz_all_valid_fields_zero() {
    ...
    let result = compute_finalization(&config, 0, 0, 0, 0, 0, 0, 0, 10, 2, 3600);
...
fn test_boundary_flow_rate_zero() {
    let e = Env::default();
    let config = default_config(&e);
    let result = compute_finalization(&config, 700, 10, 80, 250, 0, 8, 1, 10, 2, 3600);
...
fn test_boundary_baseline_n_equals_med_n() {
    ...
    let result = compute_finalization(&config, 700, 10, 80, 250, 500, 10, 1, 10, 2, 3600);
    assert_eq!(result.n_removed, 0);
...
fn test_boundary_baseline_p_equals_med_p() {
    ...
    let result = compute_finalization(&config, 700, 10, 80, 250, 500, 8, 2, 10, 2, 3600);
    assert_eq!(result.p_removed, 0);
    assert!(result.n_removed > 0);
}
...
fn test_boundary_both_baselines_equal_medians() {
    let e = Env::default();
    let config = default_config(&e);
    let result = compute_finalization(&config, 700, 10, 80, 250, 500, 10, 2, 10, 2, 3600);
    assert_eq!(result.n_removed, 0);
    assert_eq!(result.p_removed, 0);
...
fn test_boundary_all_penalties_maximum() {
    ...
    let result = compute_finalization(&config, 300, 200, 10, 350, 500, 8, 1, 10, 2, 3600);
...
fn test_boundary_penalty_capped_at_8000() {
    ...
    let result = compute_finalization(&config, 0, 10000, 0, 10000, 1000, 0, 0, 10, 2, 3600);
    assert!(result.penalty <= 8000);
...
fn test_boundary_medians_at_i64_max_safe_range() {
    ...
    let config = default_config(&e);
    let result = compute_finalization(
        &config, 1400, 0, 1000, 0, 1_000_000, 0, 0, 10, 2, 3600,
    );
    assert!(result.total >= 0);
    assert!(result.penalty <= 8000);
...
fn test_boundary_ph_at_threshold_boundaries() {
    ...
    let r1 = compute_finalization(&config, 600, 10, 80, 250, 500, 8, 1, 10, 2, 3600);
    assert_eq!(r1.penalty, 0);
    // ph exactly at upper bound 700 -> no penalty
    let r2 = compute_finalization(&config, 700, 10, 80, 250, 500, 8, 1, 10, 2, 3600);
    assert_eq!(r2.penalty, 0);
    // ph just outside: 599 and 701
    let r3 = compute_finalization(&config, 599, 10, 80, 250, 500, 8, 1, 10, 2, 3600);
    assert_eq!(r3.penalty, 2000);
    let r4 = compute_finalization(&config, 701, 10, 80, 250, 500, 8, 1, 10, 2, 3600);
...
fn test_boundary_credit_per_kg_zero() {
    ...
    let result = compute_finalization(&config, 700, 10, 80, 250, 500, 8, 1, 10, 2, 3600);
    // Only volumetric credit remains
...
fn test_boundary_baseline_zero() {
    ...
    let r1 = compute_finalization(&config, 700, 10, 80, 250, 500, 0, 0, 0, 0, 3600);
    ...
    let r2 = compute_finalization(&config, 700, 10, 80, 250, 500, 0, 0, 10, 2, 3600);
...
fn test_boundary_temperature_at_threshold() {
    ...
    let r1 = compute_finalization(&config, 700, 10, 80, 300, 500, 8, 1, 10, 2, 3600);
    assert_eq!(r1.penalty, 0);
    // temp 301 => penalty +1000
    let r2 = compute_finalization(&config, 700, 10, 80, 301, 500, 8, 1, 10, 2, 3600);
...
fn test_boundary_turbidity_and_do_at_thresholds() {
    ...
    let r1 = compute_finalization(&config, 700, 50, 80, 250, 500, 8, 1, 10, 2, 3600);
    assert_eq!(r1.penalty, 0);
    let r2 = compute_finalization(&config, 700, 51, 80, 250, 500, 8, 1, 10, 2, 3600);
    assert_eq!(r2.penalty, 2000);

    // DO exactly 50 => no penalty, 49 => penalty
    let r3 = compute_finalization(&config, 700, 10, 50, 250, 500, 8, 1, 10, 2, 3600);
    assert_eq!(r3.penalty, 0);
    let r4 = compute_finalization(&config, 700, 10, 49, 250, 500, 8, 1, 10, 2, 3600);
    assert_eq!(r4.penalty, 2000);
}
...
fn test_boundary_flow_rate_max_no_overflow() {
    ...
    let e = Env::default();
    let config = default_config(&e);
    let result = compute_finalization(&config, 700, 10, 80, 250, 1_000_000, 8, 1, 10, 2, 3600);
    assert!(result.total >= 0);
